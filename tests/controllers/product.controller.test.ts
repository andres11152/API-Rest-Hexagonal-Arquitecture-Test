...
describe("ProductController", () => {
  ...
  it("should get all products", async () => {
    ...
    MockedProductService.prototype.getAllProducts.mockResolvedValue(
      mockProducts,
    );
    ...
    expect(MockedProductService.prototype.getAllProducts).toHaveBeenCalledTimes(
      1,
    );
  });
  ...
  it("should get a product by id", async () => {
    ...
    MockedProductService.prototype.getProductById.mockResolvedValue(
      mockProduct,
    );
    ...
    expect(res.body).toEqual(expectedBody);
    expect(MockedProductService.prototype.getProductById).toHaveBeenCalledWith(
      "1",
    );
  });
  ...
  it("should compare two products", async () => {
    ...
    MockedProductService.prototype.compareProducts.mockResolvedValue(
      comparisonResult,
    );
    ...
    expect(res.body).toEqual(expectedBody);
    expect(MockedProductService.prototype.compareProducts).toHaveBeenCalledWith(
      "1",
      "2",
    );
  });
  ...
  describe("Error Handling", () => {
    ...
    it("should return 404 for a non-existent product", async () => {
      MockedProductService.prototype.getProductById.mockRejectedValue(
    ...
    it("should return 404 when comparing a non-existent product", async () => {
      MockedProductService.prototype.compareProducts.mockRejectedValue(
        new ProductNotFoundException("Not Found"),
      );
